...
Each component in the library has its own set of class names that can be used to customize its appearance. You can use these class names in combination with the `sx` prop or a `makeStyles` function to style the components.
